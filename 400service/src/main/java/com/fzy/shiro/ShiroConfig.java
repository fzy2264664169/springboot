...
//		filterChainDefinitionMap.put("/update", "authc");
		...
		//错误处理测试地址放行
		filterChainDefinitionMap.put("/exceptionHanding", "anon");
		//jpa和mybatis测试地址放行
		filterChainDefinitionMap.put("/listCategory", "anon");
...
//		filterChainDefinitionMap.put("/*", "authc");
	...
	/**
	 * 创建DefaultWebSecurityManager——关联Realm类
	 */
